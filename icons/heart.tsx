export const Heart = ({width = '24', height = "24", color = null, stroke = '#272738 '}) => {
    return <svg width={width} height={height} viewBox="0 0 24 23" fill={color ? color : 'none'} xmlns="http://www.w3.org/2000/svg">
        <path
